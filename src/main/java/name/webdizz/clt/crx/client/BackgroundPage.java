 ...
 */
@Extension.ManifestInfo(name = "Terciman (by Izzet Mustafa)", description = "The Google Chrome extension to translate selected word to/from Crimean Tatar language", version = BackgroundPage.VERSION, permissions = {
